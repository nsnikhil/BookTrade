...
public class adapterRequest extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        myViewHolder.heading.setText(String.valueOf(mList.get(position).getName().toUpperCase().charAt(0)));
    ...
    static class MyViewHolder {
        @BindView(R.id.requestHeading)
        TextView heading;
        @BindView(R.id.requestName)
        TextView name;
        @BindView(R.id.requestPublisher)
        TextView publisher;
        @BindView(R.id.requestHeadingContainer)
